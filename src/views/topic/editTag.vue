...
<template>
    <div class="main">
        <div class="navbar">
            <el-button type="primary" plain @click="router.push({path: '/admin/control/tag/list',query:{parentId:(route.query.sourceParentId != undefined ? route.query.sourceParentId:''), page:(route.query.page != undefined ? route.query.page:'')}})">返回</el-button>
        </div>
                    ...
                    if(result.code === 200){//成功
                        ...
                        if(_tag != null){
                            for(let multiLanguageExtensionParameter in state.multiLanguageExtensionParameterMap){
                                 if(_tag.multiLanguageExtensionMap['name-'+multiLanguageExtensionParameter] != undefined && _tag.multiLanguageExtensionMap['name-'+multiLanguageExtensionParameter] != null ){
                                    Object.assign(state.multiLanguageExtensionField, {['name-'+multiLanguageExtensionParameter] : _tag.multiLanguageExtensionMap['name-'+multiLanguageExtensionParameter]});
                                }
                            }

                            if(_tag.image != null && _tag.image != ''){
