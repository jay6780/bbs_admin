    ...
    <div class="main">
        <div class="nav-breadcrumb">
            <el-breadcrumb :separator-icon="ArrowRight">
                <el-breadcrumb-item @click="router.push({path: '/admin/control/tag/list'});">全部标签</el-breadcrumb-item>
                <el-breadcrumb-item v-for="(value, key) in state.navigation" @click="router.push({path: '/admin/control/tag/list',query:{parentId:key}});">{{value}}</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="navbar">
            <el-button type="primary" plain v-if="verifyPermissionMenu('/control/tag/manage?method=add*','get')" @click="router.push({path: '/admin/control/tag/manage/add',query:{sourceParentId:(route.query.parentId != undefined ? route.query.parentId:''),parentId : state.parentId, page:(route.query.page != undefined ? route.query.page:'')}});">添加标签</el-button>
        </div>
