...
<template>
   <div>
        <div class="main" >
            <div class="data-view filterWordModule" >
                <el-form label-width="auto"  @submit.native.prevent >
                    ...
                    <el-form-item>
                        <el-button type="primary" size="large" class="submitButton" plain @click="uploadFilterWordUI($event)" >上传过滤词库</el-button>
                ...
                <el-dialog title="上传词库" v-model="state.uploadForm">
                    <el-form label-width="auto"  @submit.native.prevent>
                        <el-form-item :error="error.file">
                            <el-upload class="uploadFilterWord" drag :http-request="uploadFilterWord" :show-file-list="false" :accept="'.txt'">
                ...
                if(result){
                    if(result.code === 200){//成功
			    		...
			    		for(let key in mapData){
			    			...
			    			}else if(key == "riskSensitiveWordsList"){
