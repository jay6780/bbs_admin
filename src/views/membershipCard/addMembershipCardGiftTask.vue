...
<script lang="ts" setup>
    ...
    const submitForm = () => {
        ...
        if(state.expirationDate_start != null && state.expirationDate_start != ''){
            formData.append('expirationDate_start', dayjs(state.expirationDate_start).format('YYYY-MM-DD HH:mm:ss'));
        }else{
            formData.append('expirationDate_start', '');
        }
        
        if(state.expirationDate_end != null && state.expirationDate_end != ''){
            formData.append('expirationDate_end', dayjs(state.expirationDate_end).format('YYYY-MM-DD HH:mm:ss'));
        }else{
            formData.append('expirationDate_end', '');
        }
        ...
        if(state.restrictionGroup.registrationTime_start != null && state.restrictionGroup.registrationTime_start != ''){
            formData.append('registrationTime_start', dayjs(state.restrictionGroup.registrationTime_start).format('YYYY-MM-DD HH:mm:ss'));
        }else{
            formData.append('registrationTime_start', '');
        }
        if(state.restrictionGroup.registrationTime_end != null && state.restrictionGroup.registrationTime_end != ''){
            formData.append('registrationTime_end', dayjs(state.restrictionGroup.registrationTime_end).format('YYYY-MM-DD HH:mm:ss'));
        }else{
            formData.append('registrationTime_end', '');
        }
