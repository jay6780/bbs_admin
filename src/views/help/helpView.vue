    ...
    <div class="main">
        ...
        <div class="helpViewModule" v-if="state.help != undefined && state.help != null && Object.keys(state.help).length>0">
            <div class="help-wrap">
                ...
                <div class="operat">
                    <el-link class="item" :disabled="!verifyPermissionMenu('/control/mediaProcessQueue/manage?method=addMediaProcessQueue*','post')" href="javascript:void(0);" @click="addMediaProcessQueue(state.help.id)">添加媒体处理任务</el-link>
                ...
                <div :class="[state.help.isMarkdown != null && state.help.isMarkdown == true ? 'markdown-body-custom helpMarkdownContent' : 'main']" :ref="'help_'+state.help.id">
...
<script lang="ts" setup>
    import { type ComponentInternalInstance, getCurrentInstance, nextTick, onMounted,reactive } from 'vue';
    ...
    import { processErrorInfo,getLanguageClassName, updateURLParameter,verifyPermissionMenu, resolvePath } from '@/utils/tool';
    import type { SourceUrl, Help } from '@/types';
    ...
    //添加媒体处理任务
    const addMediaProcessQueue = (helpId:string) => {
