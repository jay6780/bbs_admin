        ...
        <div class="data-form label-width-blank" >
            <el-form label-width="auto"  @submit.native.prevent>
                ...
                <el-form-item v-if="state.chooseType==2 || state.chooseType==3 || state.chooseType==4" label=" ">
                    <el-col :span="24">
                        <div class="form-error" v-text="error.itemValue" style="margin-top: 0px;"></div>
                    </el-col>
                    <el-col :span="24">
                        <div class="item-button"><el-button size="large" :icon="Plus" @click="addItem" style="margin-top: 10px;">添加项</el-button></div>
                    </el-col>
                </el-form-item>
...
<script lang="ts" setup>
    ...
    const submitForm = () => {
        ...
        if(state.chooseType != null){
            ...
            formData.append('maxlength', state.maxlength);
        ...
        if(state.formOptions != null && state.formOptions.length >0){
            for(let i=0; i<state.formOptions.length; i++){
                ...
                formData.append('itemValue', formOption.value);
        ...
        if(state.selete_size != null){
            formData.append('selete_size', state.selete_size);
        }
        if(state.rows != null){
