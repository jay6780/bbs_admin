    ...
    <div class="main">
        ...
        <div class="data-form label-width-blank" >
            <el-form label-width="auto"  @submit.native.prevent>
                ...
                <el-form-item label="Email地址" :error="error.email" :required="true" v-if="state.type == 30">
                    <el-col :span="12"><el-input v-model.trim="state.email" maxlength="90" :clearable="true" show-word-limit></el-input></el-col>
                </el-form-item>
                <el-form-item label="手机" :required="state.type == 10 || state.type == 30? false :true" :error="error.mobile" >
                ...
                <el-form-item label="密码" :required="true" :error="error.password" v-if="state.type <= 30">
                ...
                <el-form-item label="Email地址" :error="error.email" v-if="state.type == 10 || state.type == 20">
                    <el-col :span="12"><el-input v-model.trim="state.email" maxlength="90" :clearable="true" show-word-limit></el-input></el-col>
                </el-form-item>
...
<script lang="ts" setup>
    ...
    import type { SourceUrl, UserCustom, UserRole } from '@/types';
