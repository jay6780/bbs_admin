            ...
            <el-table ref="multipleTable" :data="state.tableData" tooltip-effect="dark" :style="{ width: '100%' }" @selection-change="handleSelectionChange" stripe empty-text="没有内容">
                ...
                <el-table-column label="状态" align="center" width="110">
                    <template #default="scope">
                        ...
                        <el-tag effect="dark"  v-if="scope.row.status==100010" type="info" class="tag-wrapper" >待审核(员工\系统)删除</el-tag>
                        <el-tag effect="dark"  v-if="scope.row.status==100020" type="warning" class="tag-wrapper" >已发布(员工\系统)删除</el-tag>
                    </template>
